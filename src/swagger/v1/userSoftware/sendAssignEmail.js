module.exports = {
  post: {
    ...
    description:
      'This API endpoint allows to send an email notification to the manger of the software informing them that a request has been sent to allow the access  to a  specific software for particular user by usersoftware ID.',
    oprationId: 'assign-software-email',
    requestBody: {
      content: {
        'application/json': {
          schema: {
